...
(() => {
    ...
    const updateMessageCount = () => {
        ...
        messageCount.textContent = `${messageField.value.length} / 4000`;
    };
    ...
    contactForm?.addEventListener('submit', () => {
        if (!submitButton || !contactForm.checkValidity()) return;
        submitButton.disabled = true;
        submitButton.querySelector('span').textContent = 'Sending…';
        submitButton.querySelector('i')?.classList.replace('fa-paper-plane', 'fa-spinner');
